...
import com.deer.base.security.entity.vo.LoginUser;
...
//        查询用户
        ...
        try {
            ...
            // 4. 将令牌存储到Redis
            redisUtils.set(loginUser.getUsername(),loginUser, 300);
...
//            return new AuthVO(token, "LoginUserToken", 30l);
    ...
    public boolean logout() {
        ...
        //  从Redis删除令牌
        Boolean isDelete = redisUtils.delete(loginUser.getUsername());
